...
export function data_sorted_toastify() {
	const notify = () => toast.success("Item Sorted Successfully");
	notify();
}
// Fucntion to unsort data
export function unsorted_toastify() {
	const notify = () => toast.success("Item Unsorted Successfully");
	notify();
}
// Fucntion to cancel the editing of item
export function edit_cancel_toastify() {
	const notify = () => toast.success("Editing Cancelled Successfully");
	notify();
}
