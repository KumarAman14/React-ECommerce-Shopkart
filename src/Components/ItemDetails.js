...
import { calllRating } from "./ratingfunc2";
					...
					<div className="itemImgRatingPrice">
						...
						<div className="itemDetailsRight">
							...
							<div className="itemDetailsRating">
								Rating: &nbsp;
								{calllRating(1 - item.rating)}
								{calllRating(2 - item.rating)}
								{calllRating(3 - item.rating)}
								{calllRating(4 - item.rating)}
								{calllRating(5 - item.rating)}
							</div>
